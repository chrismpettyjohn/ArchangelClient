...
import { GangQueryListEvent } from './messages/incoming/roleplay/gang/GangQueryListEvent';
import { GangQueryOneEvent } from './messages/incoming/roleplay/gang/GangQueryOneEvent';
...
import { BugReportUpdateComposer } from './messages/outgoing/roleplay/bug-report/BugReportUpdateComposer';
import { ListMyWeaponsComposer } from './messages/outgoing/roleplay/combat/ListMyWeaponsComposer';
import { CorpCreateComposer } from './messages/outgoing/roleplay/corp/CorpCreateComposer';
import { CorpDeleteComposer } from './messages/outgoing/roleplay/corp/CorpDeleteComposer';
...
import { CorpUpdateComposer } from './messages/outgoing/roleplay/corp/CorpUpdateComposer';
...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        ...
        this._events.set(IncomingHeader.TAXI_STAND_EVENT, TaxiStandEvent);
        ...
        this._events.set(IncomingHeader.BETA_CODE_LIST_EVENT, BetaCodeListEvent);
        this._events.set(IncomingHeader.BUG_REPORT_LIST_EVENT, BugReportListEvent);
        this._events.set(IncomingHeader.BUG_REPORT_DATA_EVENT, BugReportDataEvent);
        this._events.set(IncomingHeader.PLAYER_WEAPON_LIST_EVENT, PlayerWeaponListEvent);
        this._events.set(IncomingHeader.WEAPON_DATA_EVENT, WeaponDataEvent);
        this._events.set(IncomingHeader.WEAPON_LIST_EVENT, WeaponListEvent);
        this._events.set(IncomingHeader.PLAYER_WEAPON_LIST_EVENT, PlayerWeaponListEvent);
        this._events.set(IncomingHeader.CRIME_LIST_EVENT, CrimeListEvent);
        this._events.set(IncomingHeader.CRIME_DATA_EVENT, CrimeDataEvent);
        this._events.set(IncomingHeader.PLAYER_QUERY_LIST_EVENT, PlayerQueryListEvent);
        this._events.set(IncomingHeader.PLAYER_QUERY_SKILLS_LIST_EVENT, PlayerQuerySkillsListEvent);
        ...
        this._events.set(IncomingHeader.GANG_ROLE_QUERY_LIST_EVENT, GangRoleQueryListEvent);
        this._events.set(IncomingHeader.GANG_ROLE_QUERY_ONE_EVENT, GangRoleQueryOneEvent);
        this._events.set(IncomingHeader.GANG_MEMBER_QUERY_LIST_EVENT, GangMemberQueryListEvent);
        ...
        this._events.set(IncomingHeader.NOTIFICATION_EVENT, NotificationEvent);
        this._events.set(IncomingHeader.USER_GUESTBOOK_QUERY_LIST_EVENT, UserGuestbookQueryListEvent);
        this._events.set(IncomingHeader.USER_GUESTBOOK_QUERY_ONE_EVENT, UserGuestbookQueryOneEvent);
        this._events.set(IncomingHeader.MAP_QUERY_EVENT, MapQueryEvent);
        this._events.set(IncomingHeader.MY_AMMO_LIST_EVENT, MyAmmoListEvent);
        this._events.set(IncomingHeader.AMMO_CRATE_DATA_EVENT, AmmoCrateDataEvent);
        this._events.set(IncomingHeader.WEAPON_VENDING_MACHINE_DATA_EVENT, WeaponVendingMachineDataEvent);
        this._events.set(IncomingHeader.OFFER_STORE_PRODUCT_EVENT, OfferStoreProductEvent);
        this._events.set(IncomingHeader.SHIFT_INVENTORY_PRODUCT_DATA_EVENT, StoreShiftInventoryDataEvent);
        this._events.set(IncomingHeader.CHANGE_PASSWORD_SUCCESS_EVENT, ChangePasswordSuccessEvent);
        this._events.set(IncomingHeader.CURRENT_EMAIL_EVENT, CurrentEmailEvent);
        this._events.set(IncomingHeader.USER_PROFILE_BANNER_EVENT, UserProfileBannerEvent);
    }
    ...
    private registerComposers(): void {
        ...
        this._composers.set(OutgoingHeader.BETA_CODE_GENERATE_COMPOSER, BetaCodeGenerateComposer);
        this._composers.set(OutgoingHeader.BETA_CODE_DELETE_COMPOSER, BetaCodeDeleteComposer);
        this._composers.set(OutgoingHeader.BUG_REPORT_CREATE_COMPOSER, BugReportCreateComposer);
        this._composers.set(OutgoingHeader.BUG_REPORT_UPDATE_COMPOSER, BugReportUpdateComposer);
        this._composers.set(OutgoingHeader.BUG_REPORT_DELETE_COMPOSER, BugReportDeleteComposer);
        this._composers.set(OutgoingHeader.BUG_REPORT_QUERY_LIST_COMPOSER, BugReportQueryListComposer);
        this._composers.set(OutgoingHeader.BUG_REPORT_QUERY_ONE_COMPOSER, BugReportQueryOneComposer);
        this._composers.set(OutgoingHeader.BETA_CODE_QUERY_LIST_COMPOSER, BetaCodeQueryListComposer);
        this._composers.set(OutgoingHeader.PLAYER_WEAPON_CREATE_COMPOSER, PlayerWeaponCreateComposer);
        this._composers.set(OutgoingHeader.PLAYER_WEAPON_DELETE_COMPOSER, PlayerWeaponDeleteComposer);
        this._composers.set(OutgoingHeader.PLAYER_WEAPON_QUERY_LIST_COMPOSER, PlayerWeaponQueryListComposer);
        this._composers.set(OutgoingHeader.WEAPON_CREATE_COMPOSER, WeaponCreateComposer);
        this._composers.set(OutgoingHeader.WEAPON_DELETE_COMPOSER, WeaponDeleteComposer);
        this._composers.set(OutgoingHeader.WEAPON_QUERY_LIST_COMPOSER, WeaponQueryListComposer);
        this._composers.set(OutgoingHeader.WEAPON_QUERY_ONE_COMPOSER, WeaponQueryOneComposer);
        this._composers.set(OutgoingHeader.WEAPON_UPDATE_COMPOSER, WeaponUpdateComposer);
        this._composers.set(OutgoingHeader.CRIME_CREATE_COMPOSER, CrimeCreateComposer);
        this._composers.set(OutgoingHeader.CRIME_UPDATE_COMPOSER, CrimeUpdateComposer);
        this._composers.set(OutgoingHeader.CRIME_DELETE_COMPOSER, CrimeDeleteComposer);
        this._composers.set(OutgoingHeader.CRIME_QUERY_LIST_COMPOSER, CrimeQueryListComposer);
        this._composers.set(OutgoingHeader.CRIME_QUERY_ONE_COMPOSER, CrimeQueryOneComposer);
        this._composers.set(OutgoingHeader.CRIME_UPDATE_COMPOSER, CrimeUpdateComposer);
        this._composers.set(OutgoingHeader.CORP_CREATE_COMPOSER, CorpCreateComposer);
        this._composers.set(OutgoingHeader.CORP_UPDATE_COMPOSER, CorpUpdateComposer);
        this._composers.set(OutgoingHeader.CORP_DELETE_COMPOSER, CorpDeleteComposer);
        this._composers.set(OutgoingHeader.PLAYER_QUERY_LIST, PlayerQueryListComposer);
        this._composers.set(OutgoingHeader.PLAYER_QUERY_SKILLS_LIST, PlayerQuerySkillsListComposer);
        this._composers.set(OutgoingHeader.ROOM_QUERY_LIST_COMPOSER, RoomQueryListComposer);
        this._composers.set(OutgoingHeader.CORP_EDIT_COMPOSER, CorpEditComposer);
        this._composers.set(OutgoingHeader.GANG_CREATE_COMPOSER, GangCreateComposer);
        this._composers.set(OutgoingHeader.GANG_UPDATE_COMPOSER, GangUpdateComposer);
        this._composers.set(OutgoingHeader.GANG_DELETE_COMPOSER, GangDeleteComposer);
        this._composers.set(OutgoingHeader.GANG_QUERY_ONE_COMPOSER, GangQueryOneComposer);
        this._composers.set(OutgoingHeader.GANG_QUERY_LIST_COMPOSER, GangQueryListComposer);
        this._composers.set(OutgoingHeader.GANG_ROLE_CREATE_COMPOSER, GangRoleCreateComposer)
        this._composers.set(OutgoingHeader.GANG_ROLE_UPDATE_COMPOSER, GangRoleUpdateComposer)
        this._composers.set(OutgoingHeader.GANG_ROLE_DELETE_COMPOSER, GangRoleDeleteComposer)
        this._composers.set(OutgoingHeader.GANG_ROLE_QUERY_LIST_COMPOSER, GangRoleQueryListComposer)
        this._composers.set(OutgoingHeader.GANG_ROLE_QUERY_ONE_COMPOSER, GangRoleQueryOneComposer)
        this._composers.set(OutgoingHeader.EMU_SETTINGS_QUERY_LIST_COMPOSER, EmuSettingsQueryListComposer)
        this._composers.set(OutgoingHeader.EMU_SETTINGS_UPDATE_COMPOSER, EmuSettingsUpdateComposer)
        this._composers.set(OutgoingHeader.EMU_SETTINGS_DELETE_COMPOSER, EmuSettingsDeleteComposer)
        this._composers.set(OutgoingHeader.USER_GUESTBOOK_CREATE_COMPOSER, UserGuestbookCreateComposer)
        this._composers.set(OutgoingHeader.USER_GUESTBOOK_UPDATE_COMPOSER, UserGuestbookUpdateComposer)
        this._composers.set(OutgoingHeader.USER_GUESTBOOK_DELETE_COMPOSER, UserGuestbookDeleteComposer)
        this._composers.set(OutgoingHeader.USER_GUESTBOOK_QUERY_LIST_COMPOSER, UserGuestbookQueryListComposer)
        ...
        this._composers.set(OutgoingHeader.CREATE_STORE_PRODUCT_OFFER_COMPOSER, CreateStoreProductOfferComposer);
        this._composers.set(OutgoingHeader.ACCEPT_STORE_PRODUCT_OFFER_COMPOSER, AcceptStoreProductOfferComposer);
        this._composers.set(OutgoingHeader.REJECT_STORE_PRODUCT_OFFER_COMPOSER, RejectStoreProductOfferComposer);
        this._composers.set(OutgoingHeader.SHIFT_INVENTORY_QUERY_COMPOSER, ShiftInventoryQueryComposer);
        this._composers.set(OutgoingHeader.CHANGE_PASSWORD_COMPOSER, ChangePasswordComposer);
        this._composers.set(OutgoingHeader.CHANGE_EMAIL_COMPOSER, ChangeEmailComposer);
        this._composers.set(OutgoingHeader.QUERY_EMAIL_COMPOSER, QueryEmailComposer);
        this._composers.set(OutgoingHeader.QUERY_BANNER_COMPOSER, QueryUserProfileBannerComposer);
        this._composers.set(OutgoingHeader.CHANGE_BANNER_COMPOSER, UserChangeProfileBannerComposer);
        this._composers.set(OutgoingHeader.TOGGLE_PASSIVE_MODE, TogglePassiveModeComposer);
    }
